...
class LockedSettingsDataReference {
public:
    /*------------------------------------------------------------------------------------------------------------------*/
    /*//////// Constructors / Destructor /////////////////////////////////////////////////////////////////////////////*/
    /*------------------------------------------------------------------------------------------------------------------*/

    LockedSettingsDataReference(Guard guard, T& data)
        : m_guard(std::move(guard)), m_data(data) {}
...
public:
    ...
    auto LockSharedData() const {
        return LockedSettingsDataReference<const SettingsData, decltype(m_lock.lock_shared())>(m_lock.lock_shared(), m_data);
    }
    auto LockExclusiveData() {
        return LockedSettingsDataReference<SettingsData, decltype(m_lock.lock_exclusive())>(m_lock.lock_exclusive(), m_data);
    }
