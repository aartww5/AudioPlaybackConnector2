...
inline constexpr DWORD c_exceptionCodeSigAbort = 0xE0000003;

inline std::atomic<bool> g_installed = false;
inline std::atomic<bool> g_handlingCrash = false;
inline std::atomic<DWORD> g_lastExceptionCode = 0;
inline PVOID g_vectoredHandler = nullptr;
inline std::terminate_handler g_previousTerminate = nullptr;
